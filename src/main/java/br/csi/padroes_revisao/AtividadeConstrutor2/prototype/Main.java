package br.csi.padroes_revisao.AtividadeConstrutor2.prototype;

import br.csi.padroes_revisao.AtividadeConstrutor2.exemplos.ClasseExemplo;
import br.csi.padroes_revisao.AtividadeConstrutor2.exemplos.ClasseExemplo2;
import br.csi.padroes_revisao.AtividadeConstrutor2.exemplos.ClasseExemplo3;
...
public class Main {
    public static void main(String[] args) throws NoSuchFieldException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException {
        ...
        Framework reflection = new Framework();
        ...
        //fazendo a copia
        ClasseExemplo copia = (ClasseExemplo) reflection.clonePrototype(original);
